        ...
        for (var i = 0; i < this.props.width / 12; i++) {
            ...
            if (i < 25) {
                lines.push(<View style={{
                    backgroundColor: 'pink', height: 5,
                    width: '100%', marginTop: 2
                }} />) 
            } else if (i >= 25 && i < 40) {
                lines.push(<View style={{
                    backgroundColor: 'blue', height: 5,
                    width: '100%', marginTop: 2
                }} />) 
            }  else {
            lines.push(<View style={{
        ...
        return (
            ...
            >
                ...
                {/* <Animated.View style={{
                    ...
                    backgroundColor: this.backgroundInterpolationValue || 'pink',
                    zIndex: 10,
                }}
                >
                </Animated.View>
                <Animated.View style={{
                    ...
                    width: this.props.height,
                    top:4,
                    backgroundColor: this.backgroundInterpolationValue || 'gray',
                    zIndex: 10,
                }}
                >
                </Animated.View> */}
